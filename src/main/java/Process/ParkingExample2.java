...
import Resource.PresenceSensorResourcePhilips;
...
public class ParkingExample2 {
    ...
    public static void main (String [] args) {
        try{
            //TODO: parkingId getter
            String parkingId="0002";
            ...
            parkingSmartObject.init( LOT_ID,gpsDescriptor,mqttClient,parkingId, new HashMap<>(){
                {
                    ...
                    put("presence", new PresenceSensorResourcePhilips());
                }
            });
